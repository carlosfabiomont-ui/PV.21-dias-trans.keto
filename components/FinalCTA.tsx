      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="bg-gradient-to-b from-[#1a1a1a] to-black border border-[#DAA520]/30 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <p className="text-gray-400 mb-8">
            Você recebe o Protocolo Completo + 3 Bônus Exclusivos + Acesso ao Grupo
          </p>
          ...
          <div className="bg-black/50 rounded-2xl p-6 mb-8 border border-white/10 max-w-md mx-auto relative overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center gap-1">
              ...
              <p className="text-gray-500 text-xs mt-1">Sem mensalidades • Acesso Vitalício</p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-center gap-6 opacity-70">
             ...
             <div className="flex items-center gap-2 text-xs text-gray-400">
                <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                Dados Protegidos
             </div>
             <div className="flex items-center gap-2 text-xs text-gray-400">
